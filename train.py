...
parser = argparse.ArgumentParser(description='PyTorch CRNN Training')
...
parser.add_argument('--batch_size', default=100, type=int, help='min batch size')
...
def weights_init(m):
    ...
    if classname.find('Conv') != -1:
        ...
        m.bias.data.fill_(0)
crnn = CRNN.CRNN(nclass = args.n_class)
